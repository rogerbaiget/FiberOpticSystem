function varargout = GUI_Modulator_TF(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GUI_Modulator_TF_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_Modulator_TF_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function GUI_Modulator_TF_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = GUI_Modulator_TF_OutputFcn(hObject, eventdata, handles) 
